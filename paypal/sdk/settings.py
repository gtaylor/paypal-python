# coding=utf-8
"""
This module contains config objects needed by paypal.sdk.interface.Interface.
Most of this is transparent to the end developer, as the PayPalConfig object
is instantiated by the Interface object.
"""
...
class PayPalConfig(object):
    ...
    is done by instantiating paypal.sdk.interface.Interface, passing config
