...
A dict of country codes and their full names. There are a few helper functions
provided if you'd rather not use the dict directly. Examples provided in the
t_countries.py unit tests.
"""
...
def is_valid_country_abbrev(abbrev, case_sensitive=False):
    ...
    return COUNTRIES.has_key(country_code)
...
def get_two_tuple():
    """
    Returns a two-tuple of countries and their country codes. This is useful
    for Django and other frameworks that use such things to create
    <select> HTML elements and etc.
    
    Ex:
    (('US', 'United States of America'), ('ZW', 'Zimbabwe'))
    """
